            ...
            <div class="section">
              ...
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <span class="value">{{ formatDate(booking()!.coursDate) }}</span>
                </div>
                <div class="info-item">
                  <span class="label">Durée</span>
                  <span class="value">{{ booking()!.coursDureeMinutes }} min</span>
                </div>
                <div class="info-item">
              ...
              @if (booking()!.notionsCovered || booking()!.teacherFeedback) {
                ...
                <div class="section">
                  <div class="empty-feedback">
                    ...
                    <p>Le professeur n'a pas encore ajouté de commentaire pour ce cours.</p>
                  </div>
                </div>
              }
            }
